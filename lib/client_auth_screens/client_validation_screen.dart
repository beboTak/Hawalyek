...
class CustomerValidationCode extends StatelessWidget {
  static const routeName = "customer_validation";
  const CustomerValidationCode({super.key});
        ...
        children: [
          ...
          Column(
              children: <Widget>[
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).pushNamed(CustomerLocation.routeName);
