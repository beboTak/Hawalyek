...
import 'client_auth_screens/customer_image_profile_screen.dart';
import 'craft_auth_screens/caftmen_image_profile_screen.dart';
import 'craft_auth_screens/choose_craft.dart';
import 'craft_auth_screens/craft_images_data_screen.dart';
import 'craft_auth_screens/craft_result_screen.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
          ...
          ChangeNotifierProvider<CraftProvider>(create: (_) => CraftProvider()),
      ...
      child: MaterialApp(
       ...
       // HomeScreen(),
        ...
        routes: {
          ...
          CraftImageProfile.routeName:(ctx)=>const  CraftImageProfile(),
          CraftImageDataScreen.routeName:(ctx)=>const  CraftImageDataScreen(),
          ResultCraftScreen.routeName:(ctx)=>ResultCraftScreen(),
